    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('declined', 'Declined'), ('accepted', 'Accepted'), ('pending', 'Pending')], max_length=200)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('doctor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='patients_attended', to='app.doctor', verbose_name='Patients Attended')),
                ('drugss', models.ManyToManyField(to='app.drugs')),
